...
export const GET: RequestHandler = async ({ params, locals }) => {
        ...
        include: {
            audit: {
                include: {
                    ...
                    items: {
                        include: { item: true },  // ← ganti card: true jadi item: true
                        orderBy: { id: 'asc' }
                    }
                }
            },
    ...
    await new Promise<void>((resolve, reject) => {
        ...
        y += 10;
        const stats = [
            { label: 'Total Item', val: audit.totalItems ?? 0 },  // ← ganti totalCards jadi totalItems
        ...
        const COLS = [
            ...
            { label: 'Nama Item', x: ML + 20, w: 135, align: 'left' as const },  // ← ganti "Nama Card" jadi "Nama Item"
        ...
        items.forEach((item: any, idx: number) => {
            ...
            // Perbaikan: gunakan item.item (relasi ke Item) atau field newItemName
