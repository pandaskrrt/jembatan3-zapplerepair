...
<div class="page">
    ...
    <div class="info-card">
        ...
        <div class="info-content">
            ...
            <p class="info-text">
                You are editing section <strong>"{section?.name}"</strong>. 
        ...
        <div class="preview-card">
            ...
            <div class="preview-body">
                <div class="preview-type-badge" 
                     style:background={form?.data?.type === 'display' ? 'rgba(0, 255, 0, 0.1)' : 
                                      form?.data?.type === 'storage' ? 'rgba(255, 170, 0, 0.1)' : 
                                      'rgba(0, 204, 255, 0.1)'}>
                ...
                <div class="preview-details">
                    <div class="preview-row">
                        <span>Layout:</span>
                        <span>{form?.data?.layout || section?.layout || 'layout'}</span>
                    </div>
                    <div class="preview-row">
                        <span>Cabinet:</span>
                        <span>
